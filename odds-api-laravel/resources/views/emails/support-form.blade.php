...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Se ha recibido una nueva solicitud de soporte con los siguientes detalles:</p>
            ...
            <p class="label">Descripción del problema:</p>
            <div class="message-content">{{ $messageContent }}</div>
            
            <p>Por favor, atiende esta solicitud de soporte lo antes posible.</p>
        </div>
        
        <div class="footer">
            <p>Este correo ha sido generado automáticamente desde el formulario de soporte de Predict & Win.</p>
